...
@section('content')
    ...
    <script type="text/javascript">
        var otomatis = setInterval(
            function() {
                $('#chatAreak').load('{{ route('kandidat.chat.seger', $idrefresh) }}').fadeIn("slow");
            }, 1000);
    </script>
                ...
                <div>
                    <div class="row justify-content-center min-vh-75" wire:poll="mount">
                        ...
                        @endif --}}
                                ...
                                <div class="card-body message-box" id="chatAreak">
                                    @include('kandidat.chat.chatbox')
                                ...
                                @endif --}}
                                    ...
                                    @endif --}}
                                            <div class="col-md-4">
                                                <button class="btn btn-primary d-inline-block w-100" id="submitformk"><i
