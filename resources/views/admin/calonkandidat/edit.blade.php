    ...
    <div class="card-body">
        <form action="{{ route("admin.jobs.store") }}" method="POST" enctype="multipart/form-data" id="form-name">
            ...
            <div class="form-group {{ $errors->has('alamat') ? 'has-error' : '' }}">
                ...
                <textarea type="text" id="alamat" name="alamat" class="form-control" value="" required>{{ isset($kandidat) ? $kandidat->alamat : '' }}</textarea>
            ...
            <div class="form-group {{ $errors->has('biografi') ? 'has-error' : '' }}">
                ...
                <textarea type="text" id="biografi" name="biografi" class="form-control" value="" required>{{ isset($kandidat) ? $kandidat->biografi : '' }}</textarea>
            ...
            <div class="form-group {{ $errors->has('skillutama') ? 'has-error' : '' }}">
                ...
                <input type="text" id="skillutama" name="skillutama" class="form-control" value="{{ isset($kandidat) ? $kandidat->skillutama : '' }}" required>
