...
@section('content')
    ...
    <section class="relative" id="home">
        ...
        <form method="POST" enctype="multipart/form-data" action="{{ url('formpasang') }}" id="regForm"
            style="width: 50%;">
            @csrf
            <div class="tab" id="pasangform">
                ...
                <div class="form-group">
                    ...
                    <div>
                        <input id="namaperusahaan" name="namaperusahaan" type="text" class="form-control2 "
                            oninput="this.className = ''" placeholder="Areakerja.com">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div>
                        <textarea id="deskripsiperusahaan" name="deskripsiperusahaan" style="width: 100%"
                            oninput="this.className = ''" type="text" class="form-control2 " value="" data-type="text"
                            aria-required="true" placeholder="Areakerja merupakan ..."></textarea>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div>
                        <textarea id="alamatperusahaan" name="alamatperusahaan" style="width: 100%"
                            oninput="this.className = ''" type="text" class="form-control2 " value="" data-type="text"
                            aria-required="true" placeholder="Jl. X"></textarea>
                    </div>
                </div>
            ...
            <div class="tab" id="pasangform1">
                ...
                <div class="form-group">
                    ...
                    <div>
                        <input id="title" name="title" required="" type="text" class="form-control2 " value=""
                            data-type="text" aria-required="true" placeholder="Kameramen">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div>
                        <input id="salary" name="salary" required="" type="text" class="form-control2 " value=""
                            data-type="text" aria-required="true" placeholder="1,2 Jt - 2 Jt">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div>
                        <textarea id="alamat_kantor" name="alamat_kantor" required="" type="text" class="form-control2 "
                            value="" data-type="text" aria-required="true" placeholder="Jl. A, Kota B"></textarea>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div>
                        <textarea id="short_description" name="short_description" required="" type="text"
                            class="form-control2 " value="" data-type="text" aria-required="true" placeholder="1. Lorem Ipsum
    2. Lorem Ipsum"></textarea>
                ...
                <div class="form-group">
                    ...
                    <div>
                        <textarea id="full_description" name="full_description" required="" type="text"
                            class="form-control2 " value="" data-type="text" aria-required="true" placeholder="1. Lorem Ipsum
    2. Lorem Ipsum"></textarea>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div>
                        <textarea id="min_pendidikan" name="min_pendidikan" required="" type="text" class="form-control2 "
                            value="" data-type="text" aria-required="true" placeholder="SMA/SMK"></textarea>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div>
                        <input id="min_umur" name="min_umur" required="" type="text" class="form-control2 " value=""
                            data-type="text" aria-required="true" placeholder="min: 20 Tahun">
                    </div>
                </div>
                ...
                <div class="form-group">
                    <h4>Batas Lamaran</h4>
                    <div>
                        <input id="bataslamaran" name="bataslamaran" required="" type="date" class="form-control2  "
                            data-date-format="dd-mm-yyyy" value="" data-type="date" aria-required="true">
                    </div>
                </div>
            ...
            <div class="tab" id="pasangform2">
                ...
                <div class="form-group">
                    <h2> Bagaimana Cara Mengirimkan Melamar? <span aria-hidden="true" role="presentation"
                ...
                <div class="form-group" id="paketform" style="display:none">
                    <h4>Formulir Web</h4>
                    <div>
                        <input id="paket" name="paket" type="text" class="form-control2 " value="{{ $jenis }}"
                            data-type="text" placeholder="Contoh: https://docs.google.com/forms/d/xxx">
                    </div>
                </div>
