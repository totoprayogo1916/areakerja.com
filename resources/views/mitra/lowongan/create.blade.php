                        ...
                        <div class="card-body">
                            ...
                            <div class="row container"> 
                                <div class="col-12 form-group">
                                    ...
                                    <textarea width="100%" type="text" class="form-control3" id="deskripsi_pekerjaan" name="deskripsi_pekerjaan"></textarea>
                                </div>
                            ...
                            <div class="row container"> 
                                <div class="col-12  form-group">
                                    ...
                                    <textarea width="100%" type="text" class="form-control3" id="syarat_pekerjaan" name="syarat_pekerjaan"></textarea>
                                </div>
                            </div>
                            <div class="row container"> 
                                <div class="col-12 col-sm-6 form-group">
                                ...
                                <div class="col-12 col-sm-6 form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" id="min_pendidikan" name="min_pendidikan">
                                    </div>
                                </div>
                            </div>
                            <div class="row container"> 
                                <div class="col-12 col-sm-6 form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <select id="gender" name="gender"  class="form-control" >
                                            <option value="Full Time">Laki-Laki/Perempuan</option>
                                            <option value="Part Time">Laki-Laki</option>
                                            <option value="Freelance">Perempuan</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-12 col-sm-6 form-group">
                            ...
                            <div class="row container"> 
                                <div class="col-12 col-sm-6 form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input  type="date" id="bataslamaran" name="bataslamaran" class="form-control" data-date-format="dd-mm-yyyy" value="" data-type="date" >
                                    </div>
                                </div>
                                <div class="col-12 col-sm-6 form-group">
                                    <label>Gaji</label>
