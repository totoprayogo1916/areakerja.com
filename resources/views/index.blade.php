            ...
            <div class="items gg"
                ...
                <a href="{{ route('riwayat', $job->slug) }}">
                    ...
                    @if ($job->company->gambar)
                        <img src="{{ url('img/companylogo') }}/{{ $job->company->gambar }}"
...
@section('content')
    <div class="col-lg-8 post-list">
        <div class="container rr">
            <div class="justify-content-center d-flex">
                <a href="/rekomendasi" style="color: #000; font-size: 14px;margin-bottom: 10px;">Rekomendasi Loker
                    Lainnya></a>
            </div>
        </div>
            ...
            <a href="{{ route('riwayat', $job->slug) }}">
                <div data-aos="fade-up" class="single-post align-items-center d-flex" style="width: 100%">
                    ...
                    <div class="details " style="width: 100%"
                        style="margin-top: 14px; overflow: unset; white-space: nowrap;">
                        <div class="row no-gutters" style="width: 100%;margin-left: -0.5%">
                            <div class="col-6 ">
                                <h3 class="sng-ttl" style="color: #7e7e7e">Dibutuhkan</h3>
                            </div>
                            <div class="col-6 text-right">
                                <h5 class="sng-dtl"><span class="fa fa-clock-o" aria-hidden="true"></span>
                        ...
                        <div class="title d-flex flex-row justify-content-between">
                            <div class="titles">
                                ...
                                <div class="row ttl3" style=" overflow: unset; white-space: nowrap;">
                                    <div class="col-auto">
                                        <h5 class="sng-dtl"><span class="fa fa-building-o" aria-hidden="true"></span>
                                            {{ $job->company->name }}
                                    </div>
                                    <div class="col-auto">
                                        <h5 class="sng-dtl"> <span class="fa fa-money" aria-hidden="true"></span>
                                            {{ $job->salary }}</h5>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row ttl3">
                            <div class="col-auto ">
                                <h5 class="sng-dtl"><span class="fa fa-graduation-cap" aria-hidden="true"></span>
                                    {{ $job->pendidikan }}
                            </div>
                            <div class="col-auto ">
                                <h5 class="sng-dtl"><span class="fa fa-hourglass-half" aria-hidden="true"></span>
                                    {{ $job->job_nature }}
                            </div>
                            <div class="col-auto">
                                <h5 class="sng-dtl"> <span class="fa fa-map-marker" aria-hidden="true"></span>
                                    {{ $job->location->name }}</h5>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <a class="text-uppercase loadmore-btn mx-auto d-block" href="{{ route('jobs.index') }}"
            style="margin: 50px 0;">Load More Job Posts</a>
    </div>
@endsection
