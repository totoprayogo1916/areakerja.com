                ...
                <div class="row ">
                  <div class="col-lg-12 col-md-6 col-sm-6 col-xs-6 pr-0 pt-3">
                    <div class="card-content">
                      ...
                      <p class="mb-0"><a href="#"><span class="col-green"> </span>See More Category</a></p>
                    </div>
                  </div>
                ...
                <div class="row ">
                  <div class="col-lg-12 col-md-6 col-sm-6 col-xs-6 pr-0 pt-3">
                    <div class="card-content">
                      ...
                      <p class="mb-0"><span class="col-blue"></span> Data</p>
                      <p class="mb-0"><a href="#"><span class="col-green"> </span>See More Portofolio</a></p>
                    </div>
                  </div>
                  <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pl-0">
                    <div class="banner-img">
                ...
                <div class="row ">
                  <div class="col-lg-12 col-md-6 col-sm-6 col-xs-6 pr-0 pt-3">
                    <div class="card-content">
                      ...
                      <p class="mb-0"><span class="col-blue"></span> Data</p>
                      <p class="mb-0"><a href="#"><span class="col-green"> </span>See More Product</a></p>
                    </div>
                  </div>
                  <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pl-0">
                    <div class="banner-img">
                  ...
                  <div class="row ">
                    <div class="col-lg-12 col-md-6 col-sm-6 col-xs-6 pr-0 pt-3">
                      <div class="card-content">
                        ...
                        <p class="mb-0"><span class="col-blue"></span> Data</p>
                        <p class="mb-0"><a href="#"><span class="col-green"> </span>See More Transaction</a></p>
                      </div>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pl-0">
                      <div class="banner-img">
