...
@section('content')
<div class="col-8 post-list2 gg5" >
    <div data-aos="fade-up" class="single-post2 align-items-center border-bottom" style="margin-left: auto;margin-right: auto">
        ...
        <div >
            <div style="margin-top: 15px" class="section-row">
                {!! $art->content !!}
            </div>
        </div>
    </div>
...
<div class="col-11 post-list2 gg6" >
    <div data-aos="fade-up" class="single-post2 align-items-center border-bottom" style="margin-left: auto;margin-right: auto">
        <div class="col-12 border-bottom text-center">
            <h1 style="margin-bottom: 20px; font-size: 20px">{{ $art->judul }}</h1>
        </div>

        <div >
        
            <div style="margin-top:10px; font-size:14px" class="section-row">
                {!! $art->content !!}
            </div>
        </div>
    </div>
