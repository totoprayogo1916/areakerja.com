...
class JobsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $job = Job::create([
            ...
            'short_description' => 'Membuka lowongan kerja untuk posisi sebagai Customer Service.',
        ...
        $job = Job::create([
            ...
            'short_description' => 'Pawon Resto adalah perusahaan yang bergerak dibidang kuliner.',
        ...
        $job = Job::create([
            'title'             => 'Admin',
            'short_description' => 'membuka lowongan kerja untuk posisi sebagai Admin.',
        ...
        $job = Job::create([
            ...
            'short_description' => 'membuka lowongan kerja untuk posisi sebagai Content Creator.',
        ...
        $job = Job::create([
            ...
            'short_description' => 'membuka lowongan kerja untuk posisi sebagai Barista, Waiters, Cashier.',
        ...
        $job = Job::create([
            'title'             => 'Videographer',
            'short_description' => 'PT. Kata Suhu Kita dengan brand SUHU Consulting and Training merupakah sebuah perusahaan yang bergerak di bidang jasa pelatihan dan konsultasi IT dan SDM.',
        ...
        $job = Job::create([
            ...
            'short_description' => 'The Oxalis Regency Hotel ini berjarak 2 KM dari Borobudur International Golf & Country Club',
        ...
        $job = Job::create([
            'title'             => 'Editor Video',
            'short_description' => 'JW Media Production adalah pengelola website dan beberapa channel Youtube yang berlokasi di Yogyakarta.',
        ...
        $job = Job::create([
            ...
            'short_description' => 'Membuka lowongan untuk talenta muda profesional ',
        ...
        $job = Job::create([
            ...
            'short_description' => 'Membuka lowongan untuk Human Resource Development',
